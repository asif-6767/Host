...
@app.route('/')
def home():
    return "I'm Marco File Host - Running on Render!"
...
# --- Configuration (Render.com এর জন্য Environment Variables ব্যবহার করুন) ---
TOKEN = os.environ.get('TOKEN', '8223450847:AAEyy8NVTWqgOj8FtW_SYch7jPK7bDTv-Yw')
OWNER_ID = int(os.environ.get('OWNER_ID', 8399018550))
ADMIN_ID = int(os.environ.get('ADMIN_ID', 8399018550))
YOUR_USERNAME = os.environ.get('YOUR_USERNAME', '@testtgfh')
UPDATE_CHANNEL = os.environ.get('UPDATE_CHANNEL', '@testtgfh')

# Render.com এ Persistent Storage এর জন্য
BASE_DIR = os.environ.get('RENDER', '/opt/render/project/src') if os.environ.get('RENDER') else os.path.abspath(os.path.dirname(__file__))
